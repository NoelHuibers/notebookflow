...
export const en = {
  ...
  dismiss: "Dismiss",
  askAi: "Ask AI",
  toggleNodePalette: "Toggle node palette",
  toggleMinimap: "Toggle minimap",
  thisShortcutsList: "This shortcuts list",
  closePaletteDialog: "Close palette / dialog",
...
export const de: typeof en = {
  ...
  dismiss: "Schließen",
  askAi: "KI fragen",
  toggleNodePalette: "Node-Palette ein-/ausblenden",
  toggleMinimap: "Minimap ein-/ausblenden",
  thisShortcutsList: "Diese Kürzelliste",
  closePaletteDialog: "Palette / Dialog schließen",
