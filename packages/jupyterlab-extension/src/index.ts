...
// Generated by `pnpm build:css` from style/tailwind.css (Tailwind utilities
// for the shared app-core components, themed onto --jp-* variables). Webpack
// (@jupyterlab/builder) resolves and bundles the import.
